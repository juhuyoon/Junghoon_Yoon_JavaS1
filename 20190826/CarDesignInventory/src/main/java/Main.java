    ...
    public static void menu() {
        ...
        switch(userInput) {
            case (1):
                ...
                carAdded.setYear((scan.nextLine()));
                ...
                carAdded.setMile((scan.nextLine()));

                carInventory.add(carAdded);
                menu();
                break;
            case(2):
                System.out.println("Type by which you want to remove by");
                String remove = (scan.nextLine());
                carInventory.remove(remove);
                menu();
                break;
            case(3):
                carInventory.list();
            ...
            case(4):
                ...
                switch(searchInput) {
                    ...
                    case(5):
                        ...
                        String userMiles = (scan.nextLine());
