...
public class ConsoleDaoTempImpl implements ConsoleDao{
    ...
    @Override
    @Transactional
    public com.company.JunghoonYoonU1Capstone.DTO.Console addConsole(com.company.JunghoonYoonU1Capstone.DTO.Console console) {
     ...
     */
    @Override
    public com.company.JunghoonYoonU1Capstone.DTO.Console getConsole(Integer console_id) {
        try {
     ...
     */
    @Override
    public List<com.company.JunghoonYoonU1Capstone.DTO.Console> getAllConsoles() {
    ...
    @Override
    @Transactional
    public void updateConsole(com.company.JunghoonYoonU1Capstone.DTO.Console console) {
     ...
     */
    @Override
    public List<com.company.JunghoonYoonU1Capstone.DTO.Console> getConsolesByManufacturer(String manufacturer) {
        return jdbcTemplate.query(GET_CONSOLE_BY_MANUFACTURER, this::mapConsoleToRow, manufacturer);
    }


    private com.company.JunghoonYoonU1Capstone.DTO.Console mapConsoleToRow(ResultSet rs, int rowNumber) throws SQLException {
        com.company.JunghoonYoonU1Capstone.DTO.Console console = new com.company.JunghoonYoonU1Capstone.DTO.Console();
